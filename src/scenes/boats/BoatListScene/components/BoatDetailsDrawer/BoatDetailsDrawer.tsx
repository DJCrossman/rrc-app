...
import { Activities, Boat, CreateBoat } from '@/schemas';
            ...
            <>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base">{formatManufacturer(boat.manufacturer)}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Seats</strong>
                  <p className="text-base">{formatSeatSetup(boat)}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Rigging</strong>
                  <p className="text-base">
                    {boat.rigging.charAt(0).toUpperCase() + boat.rigging.slice(1)}
                  </p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Meters</strong>
                  <p className="text-base">{formatMeters(boat.meters)}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Weight Range</strong>
                  <p className="text-base">{formatWeightRange(boat.weightRange)}</p>
                </div>
              </div>
