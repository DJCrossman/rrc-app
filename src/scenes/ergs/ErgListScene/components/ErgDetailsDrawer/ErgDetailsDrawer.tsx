          ...
          {isEditing ? (
            ...
            <>
              ...
              <div className="space-y-4">
                <div>
                  <strong className="text-sm text-muted-foreground">Manufacturer</strong>
                  <p className="text-base">{erg.manufacturer.toUpperCase()}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Serial Number</strong>
                  <p className="text-base">{erg.serialNumber || 'Not specified'}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Firmware Version</strong>
                  <p className="text-base">{erg.firmwareVersion || 'Not specified'}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Hardware Version</strong>
                  <p className="text-base">{erg.hardwareVersion || 'Not specified'}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Data Code</strong>
                  <p className="text-base">{erg.dataCode || 'Not specified'}</p>
                </div>
                <div>
                  <strong className="text-sm text-muted-foreground">Total Meters</strong>
