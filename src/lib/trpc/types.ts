...
export type AthletesResult = RouterOutputs["athletes"]["getAthletes"];
...
export type Leaderboard = RouterOutputs["analytics"]["getLeaderboard"]["data"];
